...
async def test_config_save_load_workflow():
    ...
    try:
        ...
        assert (
            tree_manager1.config.agent_description == "New incorrect agent description"
        )
        ...
        assert (
            tree2.tree_data.atlas.agent_description == "New updated agent description"
        )
        ...
        await user_manager.close_all_clients()
        await delete_config_after_completion(user_manager, user_id_1, config_id)
