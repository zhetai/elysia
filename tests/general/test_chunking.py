...
# Example: retrieve a static method from _Vectorizer by string name
vectorizer_method_name = "multi2vec_clip"
vectorizer_method = getattr(_Vectorizer, vectorizer_method_name)
assert callable(vectorizer_method)
...
async def test_correct_vectoriser():
    collection_name_full = "Test_collection_chunking_vectoriser_full"
    collection_name_named = "Test_collection_chunking_vectoriser_named"
